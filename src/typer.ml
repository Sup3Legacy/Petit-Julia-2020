...
let parcoursStruct (sE:structEnv) (aE:argsEnv) (fE:funcEnv) (b,p,str,l):(structEnv * argsEnv * funcEnv) =
  if str = "print" || str = "println" || str = "div" || str = "array_length" || str = "input_int" || str = "input_string" || str = "int_of_float" || str = "sqrt" then
...
let parcoursFonction (vE:varEnv) (fE:funcEnv) (sE:structEnv) (posStr, nameFunc, pL, posT, pjT, _):funcEnv =
  if nameFunc = "print" || nameFunc = "println" || nameFunc = "div" || nameFunc = "array_length" || nameFunc = "input_int" || nameFunc = "input_string" || nameFunc = "int_of_float" || nameFunc = "sqrt"
